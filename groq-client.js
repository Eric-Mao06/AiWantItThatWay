 ...
 * This module handles communication with Groq's API for faster LLM responses
 */

const { Groq } = require('groq-sdk');

class GroqClient {
    constructor(apiKey, model = 'llama-3.1-8b-instant', options = {}) {
        this.apiKey = apiKey;
        this.model = model;
        this.options = {
            temperature: 0.7,
    ...
    /**
     * Send a message to the Groq API with context history
     * @param {string} prompt - The prompt to send
     * @param {Object} options - Additional options for the API call
     * @returns {Promise<string>} - The response from the API
     */
